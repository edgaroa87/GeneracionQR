...
{
	public static final String LLAVE_CIFRADO_WALMART="WLTSb4z7EC4";//"B4NC0437EC4";
	...
	public static final List<String> LISTACOMPAÑIAS=Arrays.asList("Bodega Aurrera", "Sam's Club", "Superama", "Walmart");
